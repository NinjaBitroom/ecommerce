...
class CarrinhoAddFormView(FormView):
    ...
    def form_valid(self, form):
        ...
        carrinho.add_produto(produto=self.produto, quantidade=cd['quant'], atualiza_quantidade=cd['alterar'])
...
class CarrinhoDetalheTemplateView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for item in carrinho:
            item['alterar'] = CarrinhoAddProdutoForm(initial={'quant': item['quantidade'], 'alterar': True})
